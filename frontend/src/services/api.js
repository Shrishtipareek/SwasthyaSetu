...
export const authAPI = {
  ...
  registerHospital: (hospitalData) =>
    API.post('/auth/register-hospital', hospitalData),
...
export const hospitalAPI = {
  ...
  updateResources: (resources) =>
    API.put('/hospitals/resources', resources),
  getDashboardStats: () =>
...
export const resourceRequestAPI = {
  ...
  respond: (id, responseData) =>
    API.put(`/resource-requests/${id}/respond`, responseData),
  updateStatus: (id, statusData) =>
    API.put(`/resource-requests/${id}/status`, statusData),
};
...
export const ambulanceAPI = {
  ...
  update: (id, statusData) =>
    API.put(`/ambulances/${id}`, statusData),
};

export const emergencyAPI = {
  initiate: (emergencyData) =>
    API.post('/emergency', emergencyData),
  getHospitalEmergencies: () =>
    API.get('/emergency/hospital'),
  updateStatus: (id, statusData) =>
    API.put(`/emergency/${id}`, statusData),
};
...
export const campaignAPI = {
  ...
  getCampaigns: () =>
    API.get('/campaigns'),
  register: (id) =>
    API.post(`/campaigns/${id}/register`),
};
...
export const adminAPI = {
  ...
  verifyHospital: (id, statusData) =>
    API.put(`/admin/hospitals/${id}/verify`, statusData),
  getStats: () =>
    API.get('/admin/stats'),
};
...
export const bloodDonorAPI = {
  register: (donorData) =>
    API.post('/blood-donors', donorData),
  getDonors: (params) =>
    API.get('/blood-donors', { params }),
  remove: () =>
    API.delete('/blood-donors/me'),
};
